...
public class OfferCalculator {
    ...
    private OfferLine createOrderLine(CartItem cartItem) {
        ProductDetails details = productDetailsProvider.loadForProduct(cartItem.getProductId()).get();
